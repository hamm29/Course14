namespace MyFirstWinFormsProject
{
	partial class frmMessageBox
	{
		...
		private void InitializeComponent()
		{
			...
			// btnShowMessageBox
			// 
			this.btnShowMessageBox.Location = new System.Drawing.Point(305, 20);
			this.btnShowMessageBox.Name = "btnShowMessageBox";
			this.btnShowMessageBox.Size = new System.Drawing.Size(153, 41);
			...
			this.button3.Text = "Show message box with title and buttons with Image";
			this.button3.UseVisualStyleBackColor = true;
			this.button3.Click += new System.EventHandler(this.button3_Click);
			// 
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(305, 285);
			this.button4.Name = "button4";
			this.button4.Size = new System.Drawing.Size(153, 56);
			this.button4.TabIndex = 4;
			this.button4.Text = "Show message box with title and buttons with Image (Default Button)";
